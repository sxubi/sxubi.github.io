...
Note that $$1_R+1_R+\cdots+1_R=0_R$$ for $$n$$ $$1_R$$. Thus $$\ker{\i)=n\mathbb{Z}$$ for some $$n$$.    
**Definition** (Characteristic of ring)**.** Let $$R$$ be a ring and $$\i:\mathbb{Z}\to R$$ be the unique such map. The *characteristic* of $$R$$ is the unique non-negative $$n$$ such that $$\ker(\i)=n\mathbb{Z}.$$       
