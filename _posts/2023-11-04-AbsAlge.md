...
**Example.** A non-zero ideal $$n\mathbf{Z}\triangleleft\mathbf{Z}$$ is prime iff $$n$$ is prime.    
**Lemma.** An ideal $$I\triangleleft R$$ is prime iff $$R/I$$ is an integral domain.    
**Proposition.** Every maximal ideal is a prime ideal.    
For any ring $$R$$, there is a unique ring homomorphism $$\mathbf{Z}\to R$$ given by
...
**Example.** The rings $$\mathbf{Z,Q,R,C}$$ all have characteristic $$0$$. The ring $$\mathbf{Z}/n\mathbf{Z}$$ has charactersitic $$n$$. In particular, all natural numbers can be characteristics.    
...
**Definition** (Associates)**.** We say $$a,b\in R$$ are 8associates* if $$a=bc$$ for some unit $$c$$. Equivalently, if $$a|b$$ and $$b|a$$.    
