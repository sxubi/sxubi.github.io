...
&emsp;&emsp;(1) $$a\equiv a\pmod n$$;    
&emsp;&emsp;(2) if $$a\equiv b\pmod n$$, then $$b\equiv a\pmod n$$;    
&emsp;&emsp;(3) if $$a\equiv b\pmod n$$ and $$b\equiv c\pmod n$$, then $$a\equiv c\pmod n$$.    
**Theorem 2.2.** If $$a\equiv b\pmod n$$ and $$c\equiv d\pmod n$$, then    
&emsp;&emsp;(1) $$a+c\equiv b+d\pmod n$$;    
&emsp;&emsp;(2) $$ac\equiv bd\pmod n$$.    
**Definition.** Let $$a$$ and $$n$$ be integers with $$n>0$$. The **congruence class* of a modulo $$n$$, denoted by $$[a]$$, is the set of all those integers that are congruent to $$a$$ modulo $$n$$, that is

$$[a]=\{b|b\in\mathbb{Z}\text{ and }b\equiv a\pmod n\}.$$

Or we could say $$[a]=\{a+kn|k\in\mathbb{Z}\}.$$    
**Theorem 2.3.** $$a=c\pmod n$$ iff $$[a]=[c]$$.     
**Corollary 2.4.** Two congruence classes modulo $$n$$ are either disjoint or identical.       
**Corollary 2.5.** There are exactly $$n$$ distinct congruence classes modulo $$n$$, namely $$[0],[1],[2],\cdots,[n-1].$$    
**Definition.** The set of all congruence classes modulo $$n$$ is denoted $$\mathbb{Z}_n$$ (read "$$\mathbb{Z}$$ mod $$n$$").      
**Remark.** The elements of $$\mathbb{Z}$$ are classes, not single integers. The set $$\mathbb{Z}_n$$ has exactly $$n$$ elements. For example, $$\mathbb{Z}_3$$ consists of 3 elements $$[0],[1],[2]$$.     
