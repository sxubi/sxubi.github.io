...
> * Dealing with "of measure 0": consider an open interval. For example, for closed interval $$[a,b]$$, consider $$(a,b)$$ and then include the endpoints $$a,b$$.
...
> * When using Lebsgue's theorem, remember to deal with sets.
