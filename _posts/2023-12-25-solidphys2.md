...
<<<<<<< HEAD:_posts/2023-12-23-solidphys2.md

<u>(1)</u> The wavevector of the hole is $$\mathbf{k}_h=-\mathbf{k}_e.$$

<center><img src="http://sxubi.github.io/photos/solid_state/hole1.png" width = "250"/><img src="http://sxubi.github.io/photos/solid_state/hole2.png" width = "250"/></center>
...
=======
<u>1. Wavevector</u> $$\mathbf{k}_h=-\mathbf{k}_e.$$     
<u>2. Energy</u> $$\epsilon_h(\mathbf{k}_h)=-\epsilon_e(\mathbf{k}_e).$$      
<u>3. Velocity</u> $$\mathbf{v}_h=\mathbf{v}_e.$$       
<u>4. Mass</u>$$m_h=-m_e.$$      
<u>5. Equation of motion</u> $$\displaystyle\hbar\frac{d\mathbf{k}_h}{dt}=e(\mathbf{E}+\frac{1}{c}\mathbf{v}_h\times\mathbf{B}).$$ The equation of motion for a hole is that of a particle of positive charge $$e$$.
>>>>>>> 4d0ea7c05533fae91da6c5b30cf019b6c7be98cc:_posts/2023-12-25-solidphys2.md
