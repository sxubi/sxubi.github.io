...
Let $$W\subseteq\mathbb{R}^n$$ be a subspace. Suppose $$u_1,u_2,...,u_p$$ is an orthogonal basis for $$W$$. The orthogonal projection of vector $y$ onto $$W$$ is
...
4. Let $$U=[u_1\quad u_2\cdots u_m], V=[v_1\quad v_2\cdots v_n]$$ and 
