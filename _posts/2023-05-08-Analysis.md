...
**Definitions.** Let $$S$$ be an interval of positive length. A function $$f:S\to\mathbb{R}$$ is differentiable at $$x_0\in S$$ iff $$f'(x_0)=\lim_{x\to x_0}\displaystyle\frac{f(x)-f(x_0)}{x-x_0}$$ exists in $$\mathbb{R}$$. Also, $$f$$ is 
