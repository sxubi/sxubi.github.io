...
**Definition.**&emsp;Let $$a$$ and $$b$$ be integers, not both $$0$$. The *greatest common divisor (gcd)* of $$a$$ and $$b$$ is the largest integer $$d$$ that divides both $$a$$ and $$b$$. In other words, $$d=gcd(a,b)$$ iff    
&emsp;&emsp;(i) $$d|a$$ and $$d|b$$,     
&emsp;&emsp;(ii) if $$c|a$$ and $$c|b$$, then $$c\leq d$$.   
**Theorem 1.3.**&emsp;Let $$a$$ and $$b$$ be integers not both $$0$$, and let $$d$$ be their greatest common divisor. Then there exists integers $$u$$ and $$v$$ such that 
...
## <center>II. Congruence in Z and Modular Arithmetic</center>
