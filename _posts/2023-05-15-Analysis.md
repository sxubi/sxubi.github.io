...
▲**Theorem (Absolute Convergence Test).** If $$\displaystyle\sum_{k=1}^\infty|a_k
|$$ converges, then $$\displaystyle\sum_{k=1}^\infty a_k$$ converges. 

**Definition.** $$\displaystyle\sum_{k=1}^\infty a_k$$ converges absolutely iff $$\displaystyle\sum_{k=1}^\infty a_k$$ converges conditionally iff $$\displaystyle\sum_{k=1}^\infty a_k$$ converges but $$\displaystyle\sum_{k=1}^\infty |a_k
|$$ diverges.
