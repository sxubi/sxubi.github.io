...
Here $$\alpha=\{n_1,n_2,\cdots\}$$ are the occupations ($$\alpha$$ represents a state, characterised by $$n_j$$'s). And $$E_\alpha=\sum n_jE_j,N_\alpha=\sum n_j$$. 
...
$$\mathcal{Z}_j^B=\frac{1}{e^{-\beta(E_j-\mu)}}.$$

The **Bose-Einstein distribution**

$$\langle n_j\rangle=\frac{1}{e^{\beta(E_j-\mu)}-1}.$$

<center><img src="http://sxubi.github.io/photos/fermi-dirac.png" width = "200"/><img src="http://sxubi.github.io/photos/3distribution.png" width = "200"/></center>
