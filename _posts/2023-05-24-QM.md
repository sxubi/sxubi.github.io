...
* The state with the highest total spin will have the lowest energy;
* For a given $$S$$, the state with highest $$L$$, consistent with overall antisymmetrization, will have the lowest energy;
* If a subshell $$nl$$ is no more than half filled, then the lowest energy have $$J=|L-S|$$; if it's more than half filled, then $$J=L+S$$ has the lowest energy.
