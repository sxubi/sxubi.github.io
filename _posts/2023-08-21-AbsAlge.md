...
&emsp;(1) every divisor of the nonzero integer $$a$$ is less than or equal to $$|a|$$;    
&emsp;(2) a nonzero integer has only finitely many divisors.     
...
&emsp;(i) $$d|a$$ and $$d|b$$,     
&emsp;(ii) if $$c|a$$ and $$c|b$$, then $$c\leq d$$.   
...
&emsp;(i) $$d|a$$ and $$d|b$$;     
&emsp;(ii) if $$c|a$$ and $$c|b$$, then $$c|d$$.    
