...
> Let $$G(n)$$ denote the greatest order of an element in $$S_n$$. To make $$G(x)$$ maximized, choose prime powers whose sum is $$\leq n$$ and whose product is as large as possible.
...
### <center>Lecture 11. The Isomorphism Theorem, Group Action and Orbit</center>
