...
> * $$\langle r^d\rangle, d|n$$,
> * $$\langle r^d,r^is\rangle,d|n,0\leq i\leq d-1$$.
> If $$n$$ is odd, the normal subgroups are given by $$D_{2n}$$ and all $$\langle r^d\rangle$$. If $$n$$ is even, there are two more normal subgroups: $$\langle r^2,s\langle$$ and $$\langle r^2,rs\rangle.$$
