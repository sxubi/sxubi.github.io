...
---
![Static Badge](https://img.shields.io/badge/Category-Notes-blue) ![Static Badge](https://img.shields.io/badge/Subject-Mathematics-green) ![Static Badge](https://img.shields.io/badge/Updating-brown)  
...
### <center>Lecture 11. The Isomorphism Theore, Group Action and Orbit</center>
...
**Proposition.** Let $$X$$ be a set and $$G$$ be a group. Then $$\phi:G\to\text{Sym}X$$ is a homomorphism (an action) iff $$\theta:G\times X\to X$$ defined by $$\theta(g,x)=\phi(g)(x)$$ satisfies &emsp; 1. $$\forall g\in G, x\in X,\theta(g,x)\in X.$$    
