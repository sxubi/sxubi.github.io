...
$$\mu=\frac{m_1m_2}{m_1+m+2}=\left(\frac{1}{m_1}+\frac{1}{m_2}\right)^{-1}.$$
...
$$p_x=\frac{\partial L}{\partial\dot{x}_{cm}}=(m_1+m_2)\dot{x}_{cm},\quad p_y=\frac{\partial L}{\partial\dot{y}_{cm}}=(m_1+m_2)\dot{y}_{cm}$$
...
$$\frac{1}{2}\mu\left(\dot{r}^2+r^2\dot{\theta}^2\right)+U(r)=\frac{1}{2}\mu\dot{r}^2+\left(\frac{\ell^2}{2\mu r^2}+U(r)\right).$$
...
$$\dot{r}=\sqrt{\frac{2}{\mu}(E-V_ell(r))}.$$
...
$$\frac{dr}{d\theta}\dot{\theta}=\frac{\ell}{\mu r^2}\frac{dr}{d\theta}=\sqrt{\frac{2}{\mu}(E-V_ell(r))}.$$

Solving this equation yields the trajectory $$r(\theta)$$.


### Kepler's Law
1. The orbit of the planet is an ellipse with the Sun sitting at one of the two foci.
2. Given the same interval of time, the area swept out by a line connecting the planet to the Sun is the same.
3. Let $$T$$ be the period of the orbit and $$a$$ be the semi-major axis, then $$T^2\propto a^3$$.
