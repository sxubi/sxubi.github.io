...
Consider a free electron gas in 1D. An electron of mass $$m$$ is confined to a length $$L$$ by infinite barriers. Use the term *orbital* to denote a solution of the wave equation for a system of only one electron. Solving the Schrodinger equation gives
