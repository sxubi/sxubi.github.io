...
## 1st ODE
#### <u>Autonomous Equations</u>

$$\frac{dy}{dt}=f(y).$$

#### <u>Seperable Equations</u>
Suppose we have
...
#### <u>Homogeneous Equations with Constant Coefficients</u>
Consider
...
#### <u>Series Solutions Near an Ordinary Point</u>
Suppose $$x=0$$ is an ordinary point. If $$x=x_0$$, simply replace $$x$$ by $$x-x_0$$ in the final solution. For $$x>0$$, Let 
