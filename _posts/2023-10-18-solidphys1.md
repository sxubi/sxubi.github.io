...
Consider $$u_s=\exp(-i\omega t).$$ And $$u_{s\pm 1}=u\exp(isKa)\exp(\pm iKa).$$ The *dispersion relation* is given by solving the above equation
...
<center><img src="http://sxubi.github.io/photos/solid_state/w/k.png" width = "200"/></center>

#### *First Brillouin Zone*

$$\frac{u_{s+1}}{u_s}=\exp(iKa)=\exp(iK'a),\quad K'=K-2\pi n/a.$$

The displacement can always be described by a wavevector within the first zone. 
