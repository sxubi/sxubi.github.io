...
S_z&=\boldsymbol S^{(1)}_z+\boldsymbol S^{(2)}_z.
\end{align*}$$

Simultaneous eigenstates of $$S$$ and $$S_z$$ are doneted by $$|S,m_S\rangle$$. The total spin of two spin-1/2 particles can be $$S=0$$ (**singlet**)
