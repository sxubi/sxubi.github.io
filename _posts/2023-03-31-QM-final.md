...
Simultaneous eigentstates are $$|l,m\rangle$$:
...
$$\chi_+=\left|\frac{1}{2},+\frac{1}{2}\right\rangle,\chi_-=\left|\frac{1}{2},-\frac{1}{2}\right\rangle.$$
...
$$S_x=\frac{\hbar}{2}\begin{pmatrix}0&1\\ 1&0\end{pmatrix},S_y=\frac{\hbar}{2}\begin{pmatrix}0&-i\\ i&0\end{pmatrix},S_x=\frac{\hbar}{2}\begin{pmatrix}1&0\\ 0&-1\end{pmatrix}.$$

Eigenvalues of $$S_x$$: $$\pm\frac{\hbar}{2}$$, with eigenvectors

$$\chi_+^{(x)}=\frac{1}{\sqrt{2}}\begin{pmatrix}1\\ 1\end{pmatrix},\chi_-^{(x)}=\frac{1}{\sqrt{2}}\begin{pmatrix}1\\ -1\end{pmatrix}.$$

Eigenvalues of $$S_y$$: $$\pm\frac{\hbar}{2}$$, with eigenvectors

$$\chi_+^{(y)}=\frac{1}{\sqrt{2}}\begin{pmatrix}1\\ i\end{pmatrix},\chi_-^{(y)}=\frac{1}{\sqrt{2}}\begin{pmatrix}1\\ i\end{pmatrix}.$$
