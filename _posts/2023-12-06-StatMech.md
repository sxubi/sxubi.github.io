...
$$\lagle E\rangle=\sum_s E(s)\mathcal{P}(s)=\frac{1}{Z}\sum_s E(s)e^{-\beta E(s)},\quad \beta=\frac{1}{kT}.$$

Also we have

$$\lagle E\rangle=-\frac{1}{Z}\frac{\partial Z}{\partial\beta}=-\frac{\partial\ln Z}{\partial\beta}.$$
